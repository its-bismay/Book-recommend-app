...
import { View, Text, Platform, TouchableOpacity, Image, ActivityIndicator,KeyboardAvoidingView, ScrollView, TextInput, Alert } from 'react-native'
  ...
  const pickImage = async () => {
    try {
      if (Platform.OS !== "web") {
        ...
        if (status !== "granted") {
          Alert.alert("Permission Denied", "We need media access permissions to upload an image");
          return;
        }
      }
      ...
      const result = await ImagePicker.launchImageLibraryAsync({
        ...
        allowsEditing: true,
        aspect: [4, 3],
        quality: 0.85, // lower quality for smaller base64
        base64: true,
      });
